  ...
  <div class="w-2/3 h-fit ml-7 space-y-5">
    ...
    <div class="flex space-x-5 pt-4">
      ...
      <div>
        ...
        <input type="text" placeholder="ABC" required class="md:w-60 rounded-md border-emerald-800 focus:border-emerald-900 focus:ring-emerald-900" name="firstname" value="{{old('firstname')}}">
      </div>
      {{-- Lastname --}}
      <div>
        <label for="lastname" class="block text-sm pb-2">LastName <sup>*</sup></label>
        <input type="text" placeholder="XYZ" required  class="md:w-60 rounded-md border-emerald-800 focus:border-emerald-900 focus:ring-emerald-900" name="lastname" value="{{old('lastname')}}">
      </div>
    </div>
    <div class="flex space-x-5 pt-4">
      {{-- Phone number --}}
      <div>
        ...
        <input type="tel" name="phone"  placeholder="123456789"  class="rounded-md border-emerald-800 focus:border-emerald-900 focus:ring-emerald-900" minlength="9" maxlength="9" value="{{old('phone')}}">
      </div>
      {{-- Town\City --}}
      <div>
        <label for="city" class="block text-sm pb-2">Town / City <sup>*</sup></label>
        <input type="text" placeholder="INDIA" required  class="md:w-72 rounded-md border-emerald-800 focus:border-emerald-900 focus:ring-emerald-900" name="city" value="{{old('city')}}">
      </div>
    </div>
    {{-- Delivery address --}}
    <div>
