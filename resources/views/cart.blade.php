  ...
  <tr>
   <td class="flex">
    ...
    <div class="pl-5 pt-3 space-y-2">
     ...
     <p class="font-semibold">{{$item->price}}INR</p>
    </div>
   </td>
   <td>
   ...
   <td class="font-semibold">{{$item->price * $item->quantity}}INR</td>
   <td>
...
<div class="flex justify-between">
    <p>Subtotal</p>
    <p class="mr-3">{{Cart::getSubTotal()}}INR</p>
</div>
<div class="flex justify-between">
    <p>Total</p>
    <p class="mr-3">{{Cart::getTotal()}}INR</p>
</div>
<div class="flex justify-between">
